...
class SnackbarContent extends StatelessWidget {
          ...
          Positioned(
            ...
            child: Stack(
              ...
              children: [
                ...
                Positioned(
                  top: size.height * 0.015,
                  child: SvgPicture.asset(assetSVG(contentType), height: 18),
                ),
              ],
            ),
          ),
  ...
  String assetSVG(ContentType contentType) {
    return switch (contentType) {
      ...
      ContentType.failure => AssetsPath.failure,

      /// success will show `CHECK`
      ContentType.success => AssetsPath.success,

      /// warning will show `EXCLAMATION`
      ContentType.warning => AssetsPath.warning,

      /// help will show `QUESTION MARK`
      ContentType.help => AssetsPath.help,

      /// default to failure will show `CROSS`
      _ => AssetsPath.failure,
    };
  }
